            ...
            <div class="p-4 border-t border-slate-100 dark:border-slate-800 shrink-0 flex items-center gap-2">
                <a href="{{ route('about') }}"
                    class="w-8 h-8 rounded-lg flex items-center justify-center shrink-0
                           ...
                           transition-colors duration-150"
                    title="About Lexiscope">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                </a>
                @auth
                    <a href="{{ route('dashboard') }}" class="flex-1 btn-primary btn-sm text-center text-xs bg-brand-600 text-white rounded-lg py-1.5 hover:bg-brand-700 transition">
                        Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}" class="flex-1 btn-primary btn-sm text-center text-xs bg-brand-600 text-white rounded-lg py-1.5 hover:bg-brand-700 transition">
                        Contributor Login
                    </a>
                @endauth
                                                ...
                                                <h3
                                                    ...
                                                    @if ($section->children->isEmpty())
                                                        @if ($section->status === 'ai_generated')
                                                            <span
                                                                class="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-sans font-semibold uppercase tracking-wider bg-amber-50 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400 border border-amber-100 dark:border-amber-800 shrink-0"
                                                                title="This content was generated by AI and has not yet been verified by a human expert.">
                                                                <svg class="w-2.5 h-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                                                </svg>
                                                                Unverified AI Result
                                                            </span>
                                                        @elseif ($section->verifiedBy)
                                                            <span
                                                    ...
                                                    @foreach ($section->children as $subsection)
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                @if ($subsection->status === 'ai_generated')
                                                                    <span
                                                                        title="Unverified AI Result"
                                                                        class="md:hidden inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[9px] font-sans font-bold uppercase tracking-wider bg-amber-50 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400 border border-amber-100 dark:border-amber-800">
                                                                        <svg class="w-2 h-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                                                        </svg>
                                                                    </span>
                                                                @elseif ($subsection->verifiedBy)
                                                                    <span
                                                            ...
                                                            <div class="flex-1 min-w-0">
                                                                ...
                                                                <div class="mt-3 flex items-center flex-wrap gap-2">
                                                                    @if ($subsection->status === 'ai_generated')
                                                                        <span
                                                                            class="hidden md:inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-sans font-semibold uppercase tracking-wider bg-amber-50 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400 border border-amber-100 dark:border-amber-800"
                                                                            title="This content was generated by AI and has not yet been verified by a human expert.">
                                                                            <svg class="w-2.5 h-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                                                            </svg>
